...
@php
    ...
    $attrStyle = 'display: block; font-size: 0.875rem; font-weight: 400; letter-spacing: 0; opacity: 0.7;';
@endphp
...
@else
    <div class="fi-logo" style="display: block; line-height: 1.1;">
        ...
        <span style="{{ $attrStyle }} margin-top: 0.1rem;">By <span @click.stop="window.open('https://areseducation.org','_blank')" style="text-decoration: underline; cursor: pointer;">ARES Education</span></span>
    </div>
@endif
