...
This project has domain-specific skills available, tracked in `.agents/skills/`. You MUST activate the relevant skill whenever you work in that domain—don't wait until you're stuck.
